...
//    this.metadataService = this.appContext.getBean(Java.type("org.hisp.dhis.dxf2.metadata.MetadataExportService"));
//    this.nodeService = this.appContext.getBean(DefaultNodeService);
