var Metadata = function(dhisScriptContext) {
    ...
    this.SystemService = Java.type("org.hisp.dhis.system.SystemService");
    this.DefaultSystemService = Java.type("org.hisp.dhis.system.DefaultSystemService");
    this.DefaultNodeService = Java.type("org.hisp.dhis.node.NodeService");
    this.DefaultMetadataService =  Java.type("org.hisp.dhis.dxf2.metadata.DefaultMetadataExportService");
    this.metadataService = this.appContext.getBean(DefaultMetadataService);
    this.nodeService = this.appContext.applicationContext.getBean(DefaultNodeService);
